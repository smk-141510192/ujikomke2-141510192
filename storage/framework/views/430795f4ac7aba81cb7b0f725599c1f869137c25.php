...
<tbody>
	...
	<td><center><a href="<?php echo e(route('kategori_lembur.edit', $data->id)); ?>" class="btn btn-warning">Update</a></center></td>  
	<td>                                            
	<center><?php echo Form::open(['method' => 'DELETE', 'route'=>['kategori_lembur.destroy', $data->id]]); ?>
